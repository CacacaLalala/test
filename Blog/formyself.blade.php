...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Your Blog
                <small>There is your posted text</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="/laravel-master/maggie/public/start"><i class="fa fa-dashboard"></i> Start</a></li>
                <li><a href="/laravel-master/maggie/public/article">Add</a></li>
                <li><a href="{{url('/article/changepass')}}{{'/'.$user_id}}">change password</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{url('/article/look')}}{{'/'.$article->uid}}">查看</a>
                            <a href="{{url('/article/change')}}{{'/'.$article->uid}}">修改</a>
                            <a href="{{url('/article/deletepost')}}{{'/'.$article->uid}}">删除</a>
                            <div class="box-tools">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('/article/delete')}}{{'/'.$comment->comment_id}}">删除</a></td>
                                        @endif
                                    @endforeach
                                </tr>
