    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/laravel-master/maggie/public/Admin"><i class="fa fa-dashboard"></i> Blog Admin</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        ...
                                        <a href="{{url('/article/adminlook')}}{{'/'.$user->id}}">查看</a>
                                        <a href="{{url('/article/admindelete')}}{{'/'.$user->id}}">删除</a>
                                        <div class="box-tools">
